...
- [7 Homebrew Tools That Replace GUI Apps]({{ site.baseurl }}/docs/news/homebrew-cli-tools/) — sister piece on dev-workflow CLI tooling
...
- [7 Homebrew Tools]({{ site.baseurl }}/docs/news/homebrew-cli-tools/) — complementary personal-productivity article
