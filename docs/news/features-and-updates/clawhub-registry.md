...
nav_order: 8
permalink: /docs/news/clawhub-registry/
---
...
- [Skills Ecosystem]({{ site.baseurl }}/docs/skills-ecosystem/) — the parallel skill registry
- [9 Agent Skills Repos I Tried]({{ site.baseurl }}/docs/news/nine-skills-repos/) — community-curated skill picks
- [/skillify article]({{ site.baseurl }}/docs/news/skillify-hidden-skill/) — generate skills from your own patterns
