...
nav_order: 15
permalink: /docs/news/minimax-cli/
---
...
- [Tool Comparison]({{ site.baseurl }}/docs/comparison/) — the landscape view
- [Hermes IDE]({{ site.baseurl }}/docs/news/hermes-ide/) — another new entrant
- [Cursor 3 agent-first]({{ site.baseurl }}/docs/news/cursor-3-agent-first/) — the biggest competitor
