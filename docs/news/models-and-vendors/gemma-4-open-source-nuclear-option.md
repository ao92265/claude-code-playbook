...
nav_order: 14
permalink: /docs/news/gemma-4-open-source-nuclear-option/
---
...
- **Njenga's piece** ([Gemma 4 release]({{ site.baseurl }}/docs/news/gemma-4-release/)) is developer-facing
...
- [Gemma 4 — Google's release]({{ site.baseurl }}/docs/news/gemma-4-release/) — Njenga's developer-facing piece
- [I ran Gemma 4 as a local model in Codex CLI]({{ site.baseurl }}/docs/news/gemma-4-local-codex/) — Vaughan's hands-on benchmark
- [Local Models]({{ site.baseurl }}/docs/local-models/) — setup reference
