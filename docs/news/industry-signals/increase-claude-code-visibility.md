...
nav_order: 2
permalink: /docs/news/increase-claude-code-visibility/
---
...
- Complements Dunlop's [output-tokens-by-75% piece]({{ site.baseurl }}/docs/news/caveman-75-percent-tokens/) from the same digest.
...
- Your team has uneven Claude Code adoption (see [Rezvani's monitoring piece]({{ site.baseurl }}/docs/news/claude-code-monitoring/) — 2/7 engineers generate 80% of sessions)
...
- [Cut Claude Code's Output Tokens by 75%]({{ site.baseurl }}/docs/news/caveman-75-percent-tokens/) — Dunlop's other April 2026 piece
- [The New Claude Code Monitoring]({{ site.baseurl }}/docs/news/claude-code-monitoring/) — Rezvani's data on adoption gaps
- [Onboarding]({{ site.baseurl }}/onboarding/) — the path from "installed but under-used" to "productive"
