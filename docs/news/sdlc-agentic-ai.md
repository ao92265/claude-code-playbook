...
- Where does `/bad` fit in your sprint cycle?
- How do you code-review AI-generated PRs in bulk?
...
- [Team Setup]({{ site.baseurl }}/docs/team-setup/)
- [Adoption Playbook]({{ site.baseurl }}/docs/adoption-playbook/)
- [BMad Autonomous Development]({{ site.baseurl }}/docs/bmad/) — where /bad fits into a modern SDLC
