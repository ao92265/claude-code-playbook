...
nav_order: 50
---
> **Historical note:** this is the original launch article, preserved as written. The counts it quotes (skills, hooks, patterns) reflect the repo at launch — see the [README](https://github.com/ao92265/claude-code-playbook#readme) for current numbers.
